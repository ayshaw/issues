...
def tracermass(dataset,res,plume):
	mass=np.sum(dataset['Rndry'].values*dataset['GCC_AIRNUMDEN'].values*dataset['GCC_AIRVOL'].values*10**15)
	return(mass)
colors=['k','b']
res = 'c90'
col='k'
for tick_d in range(len(dates)):
	if res=='c90':
		#filenames132 = glob.glob('../c90_RnPbBe_L132/holding/geosgcm_gcc_lev/*201303'+dates[tick_d]+'*z.nc4')[0]
		#filenames72 = glob.glob('../c90_RnPbBe_L72/holding/geosgcm_gcc_lev/*.201303'+dates[tick_d]+'*z.nc4')[0]
		filenames72 = glob.glob('../c90_RnPbBe_L72/scratch/*.201303'+dates[tick_d]+'*z.nc4')[0]
	else:
		filenames132 = glob.glob('../c180_L132/holding/geosgcm_gcc_lev/*201303'+dates[tick_d]+'*z.nc4')[0]
		filenames72 = glob.glob('../c180_L72/holding/geosgcm_gcc_lev/*.201303'+dates[tick_d]+'*z.nc4')[0]
	#print filenames132
	print filenames72
	#lev132 = np.zeros([132])
	lev72 = np.zeros([72])
...
ax.plot(date_time, colmean_L72,color=col,linestyle=':',linewidth=3,label =res+'_'+'L72',markersize = 4)
...
plt.savefig('plume_images_hres/cons_rn_c90_nodecay.png')
